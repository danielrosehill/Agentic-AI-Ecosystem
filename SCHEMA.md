...
*Generated from `ecosystem.json` (updated: 2026-04-09). Do not hand-edit — run `python3 scripts/generate_schema.py`.*
...
### AI Browsers
<sub>`cat:actions/ai-browsers`</sub>
...
#### Headless
<sub>`cat:actions/ai-browsers/headless`</sub>
...
### Browser Automation
<sub>`cat:actions/browser-automation`</sub>
...
### Browser Tooling
<sub>`cat:actions/browser-tooling`</sub>
...
### Computer Use
<sub>`cat:actions/computer-use`</sub>
...
#### CLI
<sub>`cat:actions/computer-use/cli`</sub>
...
#### Platform Specific
<sub>`cat:actions/computer-use/platform-specific`</sub>
...
##### macOS
<sub>`cat:actions/computer-use/platform-specific/macos`</sub>
...
#### Vision UI
<sub>`cat:actions/computer-use/vision-ui`</sub>
...
<sub>`cat:actions/data-extraction-and-structuring`</sub>
...
### Financial Tools
<sub>`cat:actions/financial-tools`</sub>
...
### Integrations
<sub>`cat:actions/integrations`</sub>
...
### Marketplaces
<sub>`cat:actions/marketplaces`</sub>
...
### Software Extensions
<sub>`cat:actions/software-extensions`</sub>
...
### Agent Clusters
<sub>`cat:agents/agent-clusters`</sub>
...
### Agent Collaboration
<sub>`cat:agents/agent-collaboration`</sub>
...
### Multiagent
<sub>`cat:agents/multiagent`</sub>

*Systems built around multiple cooperating or competing agents.*

#### Large Scale Experiments
<sub>`cat:agents/multiagent/large-scale-experiments`</sub>
...
#### Swarm Prediction
<sub>`cat:agents/multiagent/swarm-prediction`</sub>
...
### Personification
<sub>`cat:agents/personification`</sub>
...
<sub>`cat:agents/synthesised-perspectives`</sub>
...
### Task Specific
<sub>`cat:agents/task-specific`</sub>

*Agents and tools built for a single specific task rather than general use.*

#### Product Design
<sub>`cat:agents/task-specific/product-design`</sub>
...
## Builders & Platforms
<sub>`cat:builders-platforms`</sub>

### Automation
<sub>`cat:builders-platforms/automation`</sub>

*General-purpose automation tools and frameworks, including GUI-driven and script-driven flows.*

#### Open Source
<sub>`cat:builders-platforms/automation/open-source`</sub>
...
##### GUI Based
<sub>`cat:builders-platforms/automation/open-source/gui-based`</sub>
...
<sub>`cat:builders-platforms/deployment-platforms`</sub>

*Platforms for deploying and hosting agents and agentic services.*

#### Serverless
<sub>`cat:builders-platforms/deployment-platforms/serverless`</sub>
...
<sub>`cat:builders-platforms/development-platforms`</sub>
...
<sub>`cat:builders-platforms/engineering-platforms`</sub>
...
### On Device Agents
<sub>`cat:builders-platforms/on-device-agents`</sub>

*Agents designed to run on-device, including phones, SBCs and edge hardware.*

#### Android
<sub>`cat:builders-platforms/on-device-agents/android`</sub>
...
#### SBCs
<sub>`cat:builders-platforms/on-device-agents/sbcs`</sub>
...
<sub>`cat:builders-platforms/optimisation-platform`</sub>
...
##### Workflow Focused
<sub>`cat:builders-platforms/saas-builders/visual-programming/workflow-focused`</sub>
...
## Context Store
<sub>`cat:context-store`</sub>

### Context
<sub>`cat:context-store/context`</sub>
...
<sub>`cat:context-store/context/context-optimisation`</sub>
...
#### Engines
<sub>`cat:context-store/context/engines`</sub>
...
#### Frontend Tools
<sub>`cat:context-store/context/frontend-tools`</sub>
...
#### Tools
<sub>`cat:context-store/context/tools`</sub>

*Utility tools, SDKs and toolkits for building, debugging and extending agentic systems.*

##### Context Managers
<sub>`cat:context-store/context/tools/context-managers`</sub>
...
#### Visualisation
<sub>`cat:context-store/context/visualisation`</sub>
...
### Context Optimisation
<sub>`cat:context-store/context-optimisation`</sub>

#### Cross-Thread Compression
<sub>`cat:context-store/context-optimisation/cross-thread-compression`</sub>

#### In-Thread Truncation
<sub>`cat:context-store/context-optimisation/in-thread-truncation`</sub>

### Embedding Pipeline Orchestrators
<sub>`cat:context-store/embedding-pipeline-orchestrators`</sub>

*Orchestration tools that manage embedding generation and ingestion pipelines.*

### Memory
<sub>`cat:context-store/memory`</sub>
...
#### File
<sub>`cat:context-store/memory/file`</sub>
...
#### Regressive
<sub>`cat:context-store/memory/regressive`</sub>
...
#### Skills
<sub>`cat:context-store/memory/skills`</sub>
...
### Personal AI
<sub>`cat:context-store/personal-ai`</sub>
...
#### Assistants
<sub>`cat:context-store/personal-ai/assistants`</sub>

  - [Leon](https://github.com/leon-ai/leon)
  - [OpenClaw](https://github.com/openclaw/openclaw)

### RAG
<sub>`cat:context-store/rag`</sub>
...
#### Engines
<sub>`cat:context-store/rag/engines`</sub>

  - [RAGFlow](https://github.com/infiniflow/ragflow)

#### Ingestion
<sub>`cat:context-store/rag/ingestion`</sub>
...
### Semantic Search
<sub>`cat:context-store/semantic-search`</sub>
...
<sub>`cat:context-store/session-state-management`</sub>

### Vector Databases
<sub>`cat:context-store/vector-databases`</sub>
...
## Destinations
<sub>`cat:destinations`</sub>

## Dev Tools & Skills
<sub>`cat:dev-tools-skills`</sub>

### Dev Tools
<sub>`cat:dev-tools-skills/dev-tools`</sub>

*Developer tooling that uses agents or supports agent development workflows.*

#### Debugging
<sub>`cat:dev-tools-skills/dev-tools/debugging`</sub>
...
#### IDE Integrations
<sub>`cat:dev-tools-skills/dev-tools/ide-integrations`</sub>
...
#### Repo Refactoring
<sub>`cat:dev-tools-skills/dev-tools/repo-refactoring`</sub>
...
### Skills
<sub>`cat:dev-tools-skills/skills`</sub>
...
#### Bundles
<sub>`cat:dev-tools-skills/skills/bundles`</sub>

##### Claude Code
<sub>`cat:dev-tools-skills/skills/bundles/claude-code`</sub>

  - [Marketing Skills](https://github.com/coreyhaines31/marketingskills)

#### Guides
<sub>`cat:dev-tools-skills/skills/guides`</sub>

  - [Taste Skill](https://github.com/Leonxlnx/taste-skill)

#### Package Library
<sub>`cat:dev-tools-skills/skills/package-library`</sub>

  - [Vercel Skills](https://github.com/vercel-labs/skills)

#### Registries
<sub>`cat:dev-tools-skills/skills/registries`</sub>

  - [Agent Skills (tech-leads-club)](https://github.com/tech-leads-club/agent-skills)

#### Standards
<sub>`cat:dev-tools-skills/skills/standards`</sub>
...
## Frameworks & Runtimes
<sub>`cat:frameworks-runtimes`</sub>

### Environments
<sub>`cat:frameworks-runtimes/environments`</sub>

*Sandboxed environments — OS, simulated worlds, virtual machines — in which agents run.*

#### OS
<sub>`cat:frameworks-runtimes/environments/os`</sub>
...
#### Remote Desktops
<sub>`cat:frameworks-runtimes/environments/remote-desktops`</sub>
...
### Frameworks
<sub>`cat:frameworks-runtimes/frameworks`</sub>
...
#### .NET
<sub>`cat:frameworks-runtimes/frameworks/net`</sub>
...
#### Computer Use
<sub>`cat:frameworks-runtimes/frameworks/computer-use`</sub>
...
<sub>`cat:frameworks-runtimes/frameworks/multiagent-orchestration`</sub>
...
#### Multimodal
<sub>`cat:frameworks-runtimes/frameworks/multimodal`</sub>
...
#### Optimisation
<sub>`cat:frameworks-runtimes/frameworks/optimisation`</sub>
...
##### Parallelisation
<sub>`cat:frameworks-runtimes/frameworks/optimisation/parallelisation`</sub>
...
#### Social Simulations
<sub>`cat:frameworks-runtimes/frameworks/social-simulations`</sub>
...
#### Stateful Design
<sub>`cat:frameworks-runtimes/frameworks/stateful-design`</sub>
...
#### Voice
<sub>`cat:frameworks-runtimes/frameworks/voice`</sub>
...
### Harnesses
<sub>`cat:frameworks-runtimes/harnesses`</sub>
...
#### Checkpointing
<sub>`cat:frameworks-runtimes/harnesses/checkpointing`</sub>

*Save and restore agent execution state across interruptions, crashes, or session boundaries.*

#### Context Compression
<sub>`cat:frameworks-runtimes/harnesses/context-compression`</sub>
...
#### Deep Research
<sub>`cat:frameworks-runtimes/harnesses/deep-research`</sub>
...
#### Platform Specific
<sub>`cat:frameworks-runtimes/harnesses/platform-specific`</sub>

*Harnesses that target a specific host OS or environment for native integration.*

##### macOS
<sub>`cat:frameworks-runtimes/harnesses/platform-specific/macos`</sub>
...
### Orchestration
<sub>`cat:frameworks-runtimes/orchestration`</sub>
...
#### Platform-Specific
<sub>`cat:frameworks-runtimes/orchestration/platform-specific`</sub>
...
### Runtimes
<sub>`cat:frameworks-runtimes/runtimes`</sub>
...
#### Data Layers
<sub>`cat:frameworks-runtimes/runtimes/data-layers`</sub>

  - [Deep Lake](https://github.com/activeloopai/deeplake)

#### Policy Engines
<sub>`cat:frameworks-runtimes/runtimes/policy-engines`</sub>
...
#### Sandboxes
<sub>`cat:frameworks-runtimes/runtimes/sandboxes`</sub>

  - [OpenSandbox](https://github.com/alibaba/OpenSandbox)

### Starter Kits
<sub>`cat:frameworks-runtimes/starter-kits`</sub>

*Opinionated starter kits and templates for kicking off agentic projects.*

#### Social Simulations
<sub>`cat:frameworks-runtimes/starter-kits/social-simulations`</sub>
...
### Desktop Clients
<sub>`cat:frontends/desktop-clients`</sub>

#### Cross-Platform
<sub>`cat:frontends/desktop-clients/cross-platform`</sub>

#### Linux
<sub>`cat:frontends/desktop-clients/linux`</sub>

#### macOS
<sub>`cat:frontends/desktop-clients/macos`</sub>

#### Windows
<sub>`cat:frontends/desktop-clients/windows`</sub>
...
### Mobile Clients
<sub>`cat:frontends/mobile-clients`</sub>

#### Android
<sub>`cat:frontends/mobile-clients/android`</sub>

#### iOS
<sub>`cat:frontends/mobile-clients/ios`</sub>

### Server Software
<sub>`cat:frontends/server-software`</sub>

### Terminal Clients
<sub>`cat:frontends/terminal-clients`</sub>
...
### Web Clients
<sub>`cat:frontends/web-clients`</sub>

## Grounding
<sub>`cat:grounding`</sub>

### Data Sources
<sub>`cat:grounding/data-sources`</sub>

*Curated data feeds and providers that agents can draw on.*

#### Financial
<sub>`cat:grounding/data-sources/financial`</sub>
...
### Grounding Tools
<sub>`cat:grounding/grounding-tools`</sub>

### Search Utilities
<sub>`cat:grounding/search-utilities`</sub>

## Inference
<sub>`cat:inference`</sub>

### Gateways
<sub>`cat:inference/gateways`</sub>

*Gateway services that sit between agents and upstream services (LLMs, tools, data).*

#### Context Compression
<sub>`cat:inference/gateways/context-compression`</sub>
...
### Workspaces
<sub>`cat:interfaces-workspaces/workspaces`</sub>
...
#### Agent Specific
<sub>`cat:models/llms/agent-specific`</sub>
...
#### By Use Case
<sub>`cat:models/llms/by-use-case`</sub>
...
##### Computer Use
<sub>`cat:models/llms/by-use-case/computer-use`</sub>
...
<sub>`cat:models/reinforcement-learning`</sub>
...
<sub>`cat:observability/evals-and-experiment-tracking`</sub>
...
#### Frameworks
<sub>`cat:observability/evals-and-experiment-tracking/frameworks`</sub>
...
#### Observability
<sub>`cat:observability/evals-and-experiment-tracking/observability`</sub>
...
### Operations
<sub>`cat:observability/operations`</sub>

*Operational concerns for running agents in production — cost, monitoring, reliability.*

#### Cost Monitoring
<sub>`cat:observability/operations/cost-monitoring`</sub>
...
## Organisations
<sub>`cat:organisations`</sub>

### Companies
<sub>`cat:organisations/companies`</sub>

### Foundations
<sub>`cat:organisations/foundations`</sub>
...
<sub>`cat:organisations/foundations-consortia`</sub>

### Government Bodies
<sub>`cat:organisations/government-bodies`</sub>
...
<sub>`cat:prompts/conversational-control`</sub>
...
### Feedback Formatting
<sub>`cat:prompts/feedback-formatting`</sub>
...
### Formatting
<sub>`cat:prompts/formatting`</sub>
...
### Agent in the Loop
<sub>`cat:safety/agent-in-the-loop`</sub>

### Guardrails
<sub>`cat:safety/guardrails`</sub>
...
#### Automation
<sub>`cat:safety/security/automation`</sub>
...
#### Control Planes
<sub>`cat:safety/security/control-planes`</sub>
...
#### Red Team
<sub>`cat:safety/security/red-team`</sub>

  - [Rogue](https://github.com/qualifire-dev/rogue)

#### Sandboxing
<sub>`cat:safety/security/sandboxing`</sub>

  - [Microsandbox](https://github.com/superradcompany/microsandbox)

## Simulations & Worlds
<sub>`cat:simulations-worlds`</sub>

### Character & Roleplay
<sub>`cat:simulations-worlds/character-roleplay`</sub>

#### Character Definition
<sub>`cat:simulations-worlds/character-roleplay/character-definition`</sub>

#### Lore & Worldbuilding
<sub>`cat:simulations-worlds/character-roleplay/lore-worldbuilding`</sub>

#### Roleplay Runtimes
<sub>`cat:simulations-worlds/character-roleplay/roleplay-runtimes`</sub>

### Geopolitical Simulation
<sub>`cat:simulations-worlds/geopolitical-simulation`</sub>
...
<sub>`cat:simulations-worlds/societal-simulations`</sub>
...
### World Generation
<sub>`cat:simulations-worlds/world-generation`</sub>
...
#### MCP
<sub>`cat:simulations-worlds/world-generation/mcp`</sub>
...
### Backend Querying
<sub>`cat:storage/backend-querying`</sub>
